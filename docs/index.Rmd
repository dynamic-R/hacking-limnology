...
The [source code](https://github.com/dynamic-R/hacking-limnology) is available.
...
- Reaction and transport in a river
...
chemostat <- function(time, init, parms) {
  with(as.list(c(init, parms)), {
    ...
    dAlg_dt <- mu * Alg - D * Alg
    dP_dt   <-  D *(P0 - P) - 1/Y * mu * Alg
    list(c(dAlg_dt, dP_dt), mu=mu)
   })
}
parms <- c(
  mumax = 0.5,    # 1/d
