...
#### Thomas Petzoldt and Karline Soetaert,  (version: `r Sys.Date()`)
...
.center[
![:scale 43%](img/batch.jpg)
![:scale 43%](img/small-stream.jpg)
![:scale 43%](img/marmots.jpg)
![:scale 43%](img/lake-dynamic.jpg)
]
